...
{ 
	...
	output(-9,-7,"By:");
	output(-9,-8,"Khushi M, \n1BI21CS062");
	output(-9,-9,"Harichandana N,\n 1BI21CS050");
	
	glColor3fv(color[0]); 
	output(2,-9,"Right click for controls...");
...
{ 	int temp_speed,i,j;
	...
	else if(key=='d'&&rotationcomplete==1) 
	{
		rotationcomplete=0; 
		rotation=2; 
		inverse=0; 
	...
	else if(key=='l'&&rotationcomplete==1) 
	{
		rotationcomplete=0;
		rotation=2; 
		inverse=1; 
	...
	else if(key=='s'&&rotationcomplete==1) 
	{
		rotationcomplete=0; 
		rotation=3; 
		inverse=0; 
	...
	else if(key=='k'&&rotationcomplete==1) 
	{
		rotationcomplete=0; 
		rotation=3; 
		inverse=1; 
	...
	else if(key=='a'&&rotationcomplete==1) 
	{
		rotationcomplete=0; 
		rotation=4; 
		inverse=0; 
	...
	else if(key=='j'&&rotationcomplete==1) 
	{
		rotationcomplete=0; 
		rotation=4; 
		inverse=1; 
	...
	else if(key=='e'&&rotationcomplete==1) 
	{
		rotationcomplete=0; 
		rotation=5; 
		inverse=0; 
	...
	else if(key=='x'&&rotationcomplete==1) 
	{
		rotationcomplete=0; 
		rotation=6; 
		inverse=0; 
	...
	else if(key=='m'&&rotationcomplete==1) 
	{
		rotationcomplete=0; 
		rotation=6; 
		inverse=1; 
	...
	else if(key=='1'&&rotationcomplete==1) 
	{ 
		p=p+2.0;
		glutIdleFunc(spincube); 
	} 
	else if(key=='8'&&rotationcomplete==1) 
	{ 
		p=p-2.0; 
		glutIdleFunc(spincube); 
	} 
	else if(key=='2'&&rotationcomplete==1) 
	{ 
		q=q+2.0; 
		glutIdleFunc(spincube); 
	} 
	else if(key=='9'&&rotationcomplete==1) 
	{ 
		q=q-2.0; 
		glutIdleFunc(spincube); 
	} 
	else if(key=='3'&&rotationcomplete==1) 
	{ 
		r=r+2.0; 
		glutIdleFunc(spincube); 
	} 
	else if(key=='0'&&rotationcomplete==1) 
	{ 
		r=r-2.0; 
		glutIdleFunc(spincube); 
	} 
	else if(key=='4'&&rotationcomplete==1) 
	{ 
		p=0.0; 
		q=0.0; 
		r=0.0; 
	...
	else if(key=='c'&&rotationcomplete==1) 
	{ 
		speed=speed+0.3; 
		if(speed<=1.3) 
		{ 
		...
		else if(speed>1.3 && speed<=2.9) 
		{
				speedmetercolor[++speedmetercount]=4; 
		} 
		else if(speed>2.9 && speed<=4.2) 
		{ 
				speedmetercolor[++speedmetercount]=5; 
		} 
		glutPostRedisplay(); 
	}
	else if(key=='n'&&rotationcomplete==1) 
	{ 
		if(speed>=0.3) 
		{ 
			speed=speed-0.3; 
	...
	else if(key=='g'&&rotationcomplete==1) 
	{  
		undo();  
	} 
	//else if(key=='6' && rotationcomplete==1){
		/*temp_speed=speed;
		speed=5;
		while(count>=0){
			printf("%d\n",count);
...
{ 
	...
	glutAddMenuEntry("  Top                   :w",1); 
	glutAddMenuEntry("  Top Inverted    :i",2); 
	glutAddMenuEntry("  Right                 :d",3); 
	glutAddMenuEntry("  Right Inverted  :l",4); 
	glutAddMenuEntry("  Front                 :s",5); 
	glutAddMenuEntry("  Front Inverted  :k",6); 
	glutAddMenuEntry("  Left                   :a",7); 
	glutAddMenuEntry("  Left Inverted    :j",8); 
	glutAddMenuEntry("  Back                  :e",9); 
	glutAddMenuEntry("  Back Inverted   :o",10); 
	glutAddMenuEntry("  Bottom              :x",11); 
	glutAddMenuEntry("  Bottom Inverted :m",12);
	glutAddMenuEntry("  Reverse move	 :g",0);
	glutAddMenuEntry("",0);
	glutAddMenuEntry("  Rotation Controls",0);
	glutAddMenuEntry("  X-Axis	:1 & 8",0);
	glutAddMenuEntry("  Y-Axis	:2 & 9",0);
	glutAddMenuEntry("  Z-Axis	:3 & 0",0);
	glutAddMenuEntry("  Origin	:4",0);
	glutAddMenuEntry("",0);
	glutAddMenuEntry("  Rotation Speed",0);
	glutAddMenuEntry("  Increase	 :c",0);
	glutAddMenuEntry("  Decrease	 :n",0);
	glutAddMenuEntry("",0);
	//glutAddMenuEntry("  Solve        :6",14);
	//glutAddMenuEntry("",0);
